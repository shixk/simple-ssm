...
<body>
<div id="searchHistory" class="easyui-panel" title="填写调休信息"
    ...
    <form id="formQueryInvoiceNeededToTms" method="post">
        <table width="800px" class="searchTable" border="0">
            ...
            <tr>
                <td align="right"><label for="offtime">调休日期:</label> <input
                        class="easyui-datetimebox"  id="offtime" name="offtime" />
                </td>
                <td width="400px">&nbsp;</td>
            </tr>
            <tr>
                <td align="right"><label for="remark">调休事由:</label> <input
...
<script type="text/javascript">
    ...
    function ok(){
        var name=$("#name").val();
        var misno=$("#misno").val();
        var offtime=$("#offtime").datetimebox('getValue');
        ...
        $.ajax({
            type: "POST",
            url: '<c:url value="/duty/insertVacationRecord"/>',
            data: {name:name,misno:misno,offtime:offtime,remark:remark},
