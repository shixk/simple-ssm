...
public class RMBTool {
    ...
    public static String toBigAmt(double amount){
        ...
        if ((dotBig.length() == 0)&&(intBig.length() != 0)) {
            return symbolFlag+intBig + "元整";
        }else if((dotBig.length() == 0)&&(intBig.length() == 0)){
            return symbolFlag+intBig + "零元";
        }else if((dotBig.length() != 0)&&(intBig.length() != 0)) {
            return symbolFlag+intBig + "元" + dotBig;
        }else{
            return dotBig;
        }
    ...
    public static void main(String[] args) {
        System.out.println(RMBTool.toBigAmt(-2467.1));
